      ...
      <div className="max-w-md w-full">
        ...
        <div className="flex justify-center mb-6">
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-500 to-brand-gold rounded-full blur-xl opacity-50"></div>
            <div className="relative bg-slate-900 rounded-full p-4 border border-brand-blue/30">
        ...
        <div className="text-center mb-8">
          ...
          <div className="inline-block bg-gradient-to-r from-cyan-500/10 to-brand-gold/10 border border-brand-blue/30 rounded-lg px-4 py-2 mb-6">
            <p className="text-brand-blue font-semibold text-sm">Requires {info.name}</p>
          </div>
        </div>
          ...
          <ul className="space-y-2">
            {info.features.map((feature, idx) => (
              <li key={idx} className="flex items-center text-slate-400 text-sm">
                <Zap className="w-4 h-4 text-brand-green mr-2 flex-shrink-0" />
                {feature}
              </li>
            ))}
          </ul>
        ...
        <div className="space-y-3">
          <Button
            ...
            className="w-full bg-gradient-to-r from-cyan-500 to-brand-gold hover:from-cyan-600 hover:to-green-600 text-black font-bold py-3 rounded-lg transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2"
          >
