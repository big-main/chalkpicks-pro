    ...
    sections: [
      {
        ...
        body: (
          <>
            <p>
              Expected value:{" "}
              <code className="text-emerald-400">EV = (p × W) − (q × L)</code>,
            ...
            <p>
              ...
              per dollar — a real edge, even though the odds alone imply only a
      ...
      },
      {
        ...
        body: (
          <p>
            A single +EV bet loses all the time — the edge is a statement about
            the average outcome across many bets at that same price, not a
            prediction about any one game. That's exactly why{" "}
      ...
      },
      {
        ...
        body: (
          <p>
            ...
            your price implies a lower probability than the sharp fair number,
            that gap is your expected value. ChalkPicks'{" "}
            <InternalLink href="/ev-finder">+EV Finder</InternalLink> runs this
            comparison across 10+ sportsbooks in real time, and once you've
            confirmed a bet is +EV,{" "}
