...
export default function AffiliateHub() {
  ...
  const affiliateLink = `https://chalkpicks.pro?ref=${user.id}`;
      ...
      <div className="container max-w-6xl mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground">
            Earn 20% commission on every referral. Build passive income.
          </p>
        </motion.div>
          ...
          <Card className="glass-card p-8 border border-green-400/20">
            ...
            <div className="mb-6">
              ...
              <div className="flex gap-2">
                ...
                />
                <Button onClick={handleCopyLink} className="btn-premium gap-2">
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {[
                    ...
                    <tr
                      key={i}
                      className="border-b border-green-400/10 hover:bg-green-400/5 transition-colors"
                    >
