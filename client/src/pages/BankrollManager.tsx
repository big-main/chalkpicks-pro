...
export default function BankrollManager() {
  ...
  const [newBet, setNewBet] = useState<{
    ...
    odds: string;
    result: "win" | "loss" | "pending";
  }>({ sport: "NBA", description: "", stake: "", odds: "", result: "pending" });
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto">
              Track your bets, manage your bankroll, and optimize unit sizing
              with Kelly Criterion calculations. No signup required.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 text-center">
              ...
              <p
                className={`text-2xl font-bold ${stats.currentBankroll >= bankroll ? "text-emerald-400" : "text-red-400"}`}
              >
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 text-center">
              ...
              <p
                className={`text-2xl font-bold ${stats.roi >= 0 ? "text-emerald-400" : "text-red-400"}`}
              >
                {stats.roi >= 0 ? "+" : ""}
                {stats.roi.toFixed(1)}%
              </p>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 text-center">
              ...
              <p
                className={`text-2xl font-bold ${stats.profit >= 0 ? "text-emerald-400" : "text-red-400"}`}
              >
              ...
              <div className="space-y-4">
                ...
                <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-lg p-3">
                  <p className="text-sm text-emerald-400">
                    Recommended bet:{" "}
                    <strong>${stats.kellyUnit.toFixed(2)}</strong> per unit
                  </p>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-6">
              ...
              <div className="space-y-3">
                ...
                <input
                  ...
                  onChange={e =>
                    setNewBet({ ...newBet, description: e.target.value })
                  }
          ...
          <div className="text-center">
            <div className="bg-gradient-to-r from-emerald-500/10 via-amber-500/10 to-emerald-500/10 border border-emerald-500/20 rounded-2xl p-8">
              ...
              <p className="text-gray-400 mb-6 max-w-lg mx-auto">
                Our AI picks have a 92% historical win rate. Combine them with
                proper bankroll management for consistent profits.
              </p>
              <Link
                href="/pricing"
