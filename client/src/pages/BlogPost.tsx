      ...
      <div className="container max-w-4xl py-8 md:py-12">
        ...
        <div className="mt-6 p-6 rounded-xl bg-gradient-to-r from-emerald-500/10 to-cyan-500/10 border border-emerald-500/20">
          ...
          <p className="text-sm text-white/50 mb-4">
            Join ChalkPicks Pro for data-driven sports betting analytics and
            daily AI picks.
          </p>
          {hasFullAccess ? (
            <Link href="/picks">
            ...
            {newsletterSubmitted ? (
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/50">
                    Expect daily AI picks and sharp money alerts in your inbox.
                  </p>
                </div>
              </div>
            ) : (
              <>
                ...
                <h3 className="text-lg font-bold text-white mb-1">
                  Get AI picks delivered to your inbox
                </h3>
                <p className="text-sm text-white/50 mb-4">
                  Join 4,200+ bettors getting daily +EV picks, line movement
                  alerts, and sharp money signals — free.
                </p>
