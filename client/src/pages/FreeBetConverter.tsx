  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <HowToJsonLd
        ...
        steps={[
          {
            name: "Enter your free bet amount",
            text: "Input the dollar value of your sportsbook free bet bonus.",
          },
          {
            name: "Enter the free bet odds",
            text: "Find a game with high odds (e.g. +200 or higher) and enter those American odds.",
          },
          {
            name: "Enter the hedge bet odds",
            text: "Find the opposite side of the same game at another sportsbook and enter those odds.",
          },
          {
            name: "Place both bets",
            text: "Place your free bet at the first sportsbook and the hedge bet with real money at the second sportsbook.",
          },
          {
            name: "Collect your guaranteed profit",
            text: "Regardless of which side wins, you collect the guaranteed profit shown by the calculator.",
          },
        ]}
      />
      <BreadcrumbJsonLd
        items={[
          ...
          { name: "Tools", url: "https://chalkpicks.pro/tools" },
          {
            ...
            url: "https://chalkpicks.pro/tools/free-bet-converter",
          },
        ]}
      />
      <FaqJsonLd faqs={FAQS} />
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-muted-foreground max-w-xl mx-auto">
              Convert any sportsbook free bet into guaranteed cash profit.
              Calculate the exact hedge bet needed to lock in profit regardless
              of outcome.
            </p>
          </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-1">
                    Higher odds = better conversion rate
                  </p>
                </div>
                <div>
                  <Label className="text-slate-300 text-sm mb-1.5 block">
                  ...
                  />
                  <p className="text-xs text-slate-500 mt-1">
                    Opposite side at another sportsbook
                  </p>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent>
                {result ? (
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-center py-2 border-b border-slate-700">
                        <span className="text-slate-400 text-sm flex items-center gap-1.5">
                          <DollarSign className="w-3.5 h-3.5" /> Hedge Bet
                          Needed
                        </span>
                        <span className="text-white font-semibold">
                          ${result.hedgeBet.toFixed(2)}
                        </span>
                      </div>
                      <div className="flex justify-between items-center py-2 border-b border-slate-700">
                        <span className="text-slate-400 text-sm flex items-center gap-1.5">
                        ...
                        <span
                          className={`font-semibold ${result.conversionRate >= 70 ? "text-[#39ff14]" : result.conversionRate >= 50 ? "text-amber-400" : "text-red-400"}`}
                        >
                      ...
                      <div className="flex justify-between items-center py-2 border-b border-slate-700">
                        ...
                        <span className="text-emerald-400 font-semibold">
                          +${result.profitIfFreeWins.toFixed(2)}
                        </span>
                      </div>
                      <div className="flex justify-between items-center py-2">
                        ...
                        <span className="text-emerald-400 font-semibold">
                          +${result.profitIfHedgeWins.toFixed(2)}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-2 p-3 rounded-lg bg-blue-500/5 border border-blue-500/20">
                      ...
                      <p className="text-xs text-slate-400">
                        ...
                        on the opposite side to guarantee{" "}
                  ...
                  <div className="text-center py-8 text-slate-500">
                    ...
                    <p className="text-sm">
                      Enter your free bet details to see results
                    </p>
                  </div>
                )}
              </CardContent>
          ...
          <Card className="border-slate-700 bg-slate-800/50 mb-6">
            ...
            <CardContent className="space-y-4 text-sm text-slate-300">
              <p>
                Free bets are promotional credits given by sportsbooks that let
                you place a bet without risking your own money — but the stake
                is not returned when you win. A free bet converter turns this
                into guaranteed cash by placing a hedge bet on the opposite
                outcome at another sportsbook.
              </p>
              <div className="grid md:grid-cols-3 gap-4 mt-4">
                {[
                  {
                    title: "Step 1: Find High Odds",
                    desc: "Look for a game where one side is priced at +150 or higher. The higher the odds on your free bet, the better your conversion rate.",
                    color: "text-[#39ff14]",
                  },
                  {
                    title: "Step 2: Calculate Hedge",
                    desc: "Use this calculator to find the exact hedge bet amount. Place the free bet on the high-odds side, and the hedge bet with real money on the other side.",
                    color: "text-blue-400",
                  },
                  {
                    title: "Step 3: Collect Profit",
                    desc: "Regardless of which side wins, you collect a guaranteed profit. The conversion rate shows what % of the free bet value you lock in as cash.",
          ...
          >
            <p className="text-foreground font-semibold mb-1">
              Find the best odds for free bet conversion
            </p>
            <p className="text-muted-foreground text-sm mb-4">
              Use ChalkPicks' odds comparison to find the highest free bet odds
              and lowest hedge juice
            </p>
