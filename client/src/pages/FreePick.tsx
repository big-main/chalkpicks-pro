    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              One free AI-generated sports pick every day with full analysis,
              confidence score, and edge rating. No account required. No credit
              card.
            </p>
          </div>
          ...
          {isLoading ? (
            ...
            <NeonCard
              className="max-w-2xl mx-auto p-0 overflow-hidden"
              variant="premium"
            >
              {/* Pick Header */}
              ...
              <div className="p-6 space-y-5">
                ...
                {/* Confidence Bar */}
                <ConfidenceBar
                  score={Number(pick.confidenceScore ?? 0)}
                  height="h-2"
                />
                ...
                {pick.result && pick.result !== "pending" && (
                  <div
                    className={`p-3 rounded-xl text-center font-bold text-sm uppercase tracking-wider ${
                      pick.result === "win"
            ...
            <NeonCard className="max-w-2xl mx-auto p-8 text-center">
              ...
              <h3 className="text-lg font-bold text-foreground mb-2">
                Today's Pick Coming Soon
              </h3>
              <p className="text-sm text-muted-foreground">
                Our AI generates fresh picks every morning. Subscribe below to
                get notified.
              </p>
            </NeonCard>
          )}
      ...
      <section className="py-12 border-t border-border/50">
        <div className="container max-w-xl mx-auto px-4 text-center">
          ...
          <p className="text-sm text-muted-foreground mb-6">
            Subscribe to receive our daily free AI pick plus graded results
      ...
      <section className="py-16 border-t border-border/50">
        <div className="container max-w-4xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-2xl font-bold text-foreground mb-2">
              Want More Than 1 Pick Per Day?
            </h2>
            <p className="text-sm text-muted-foreground">
              Premium members get 5-10 AI picks daily plus access to all
            ...
            <NeonCard className="p-6">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-primary" /> 1 AI pick
                  per day
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-primary" /> Full
                  analysis & confidence score
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-primary" /> Public track
                  record
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-primary" /> Email alerts
                </li>
              </ul>
            </NeonCard>
            <NeonCard className="p-6" variant="premium">
              <div className="flex items-center gap-2 mb-4">
                <Badge className="badge-premium border-0 text-xs">
                  PREMIUM
                </Badge>
                <span className="text-sm font-medium text-foreground">
                  From $9.99/day
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li className="flex items-center gap-2">
                  <Star className="w-4 h-4 text-yellow-400" /> 5-10 AI picks
                  daily
                </li>
                <li className="flex items-center gap-2">
                  <Star className="w-4 h-4 text-yellow-400" /> +EV Finder &
                  Arbitrage tools
                </li>
                <li className="flex items-center gap-2">
                  <Star className="w-4 h-4 text-yellow-400" /> Steam Move
                  Detector
                </li>
                <li className="flex items-center gap-2">
                  <Star className="w-4 h-4 text-yellow-400" /> CLV Tracker &
                  Kelly Calculator
                </li>
                <li className="flex items-center gap-2">
                  <Star className="w-4 h-4 text-yellow-400" /> Parlay Builder &
                  DFS Optimizer
                </li>
              </ul>
              {hasFullAccess ? (
      ...
      <section className="py-12 border-t border-border/50">
        <div className="container max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-sm text-muted-foreground mb-4">
            Every pick is publicly graded. View our complete track record with
            wins, losses, ROI, and units.
          </p>
