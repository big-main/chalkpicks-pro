...
export default function PickShare() {
  ...
  useEffect(() => {
    ...
    const imageUrl = `https://chalkpicks.live/og-pick-${pick.id}.png`;
          ...
          >
            ...
            <Card className="bg-card border-border overflow-hidden">
              ...
              <CardContent className="p-8">
                ...
                <div className="mb-6">
                  <div className="text-sm text-muted-foreground mb-2">{pick.awayTeam} @ {pick.homeTeam}</div>
                  <h1 className="font-display text-5xl tracking-wider text-foreground mb-3">{pick.recommendation}</h1>
                  {pick.odds && (
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="p-4 rounded-lg bg-background/50 border border-white/5">
                    ...
                    <div className="text-2xl font-bold text-[#39ff14]">{pick.confidenceScore || 0}%</div>
                  </div>

                  <div className="p-4 rounded-lg bg-background/50 border border-white/5">
                    <div className="flex items-center gap-2 mb-2">
                      <Zap className="w-4 h-4 text-[#f0b800]" />
                      <span className="text-xs text-muted-foreground">+EV Edge</span>
                    </div>
                  ...
                  <div className="p-4 rounded-lg bg-background/50 border border-white/5">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-xs text-muted-foreground">Kelly Bet</span>
                    </div>
                    <div className="text-2xl font-bold text-[#60a5fa]">2.1%</div>
                  </div>

                  <div className="p-4 rounded-lg bg-background/50 border border-white/5">
                    <div className="flex items-center gap-2 mb-2">
                      <TrendingUp className="w-4 h-4 text-[#06b6d4]" />
                      <span className="text-xs text-muted-foreground">Exp. ROI</span>
                    </div>
                    <div className="text-2xl font-bold text-[#06b6d4]">14.2%</div>
                  </div>
                </div>
                ...
                <div className="mt-8 pt-6 border-t border-white/5">
                  <p className="text-sm text-muted-foreground mb-4">
                    Get access to all AI picks, steam alerts, and advanced analytics
                  </p>
                  <a href="/pricing" className="inline-block px-6 py-2 rounded-lg bg-[#39ff14] text-black font-semibold hover:bg-[#39ff14]/90 transition-colors">
                    View Pricing
                  </a>
                </div>
              </CardContent>
