...
function PromoBanner({ onApply }: { onApply: () => void }) {
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(135deg, rgba(57,255,20,0.06) 0%, rgba(212,160,23,0.06) 100%)",
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-white/50 mt-0.5">
                ...
                at checkout for 15% off any plan
              </p>
            </div>
          </div>
          <button
...
const FEATURE_CATEGORIES = [
  {
    ...
    features: [
      {
        name: "AI-generated picks (daily)",
        daily: true,
        monthly: true,
        yearly: true,
        description: "Daily AI picks with confidence scores",
      },
      {
        name: "Confidence & edge scores",
        daily: true,
        monthly: true,
        yearly: true,
        description: "AI confidence and expected value metrics",
      },
      {
        name: "Live stats & player data",
        daily: true,
        monthly: true,
        yearly: true,
        description: "Real-time stats from 10+ sportsbooks",
      },
      {
        ...
        monthly: true,
        yearly: true,
        description: "View top bettors and their performance",
      },
    ],
  },
  {
    ...
    features: [
      {
        ...
        monthly: true,
        yearly: true,
        description: "Find positive expected value opportunities",
      },
      {
        ...
        monthly: true,
        yearly: true,
        description: "Detect sharp money and line movements",
      },
      {
        name: "CLV Tracker",
        daily: false,
        monthly: true,
        yearly: true,
        description: "Track closing line value for your bets",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        monthly: true,
        yearly: true,
        description: "Find risk-free arbitrage opportunities",
      },
      {
        ...
        monthly: true,
        yearly: true,
        description: "Track P&L, ROI, and betting performance",
      },
    ],
  },
  {
    ...
    features: [
      {
        ...
        monthly: true,
        yearly: true,
        description: "Access to real prediction market data",
      },
      {
        name: "Odds comparison (18+ books)",
        daily: false,
        monthly: true,
        yearly: true,
      ...
      },
      {
        ...
        monthly: true,
        yearly: true,
        description: "Historical line movement tracking",
      },
    ],
  },
  {
    ...
    features: [
      {
        name: "Email pick alerts",
        daily: false,
        monthly: true,
        yearly: true,
        description: "Daily picks delivered to your inbox",
      },
      {
        name: "Email support",
        daily: false,
      ...
      {
        name: "VIP Discord access",
        daily: false,
        monthly: false,
        yearly: true,
        description: "Exclusive Discord community for elite members",
      },
      {
        ...
        monthly: false,
        yearly: true,
        description: "Personal consulting with betting experts",
      },
      {
        ...
        monthly: false,
        yearly: true,
        description: "Deep historical analysis and simulations",
      },
    ],
  },
];
...
export default function Pricing() {
  ...
  const { data: promoResult, error: promoQueryError } =
    trpc.promoCode.validate.useQuery(
  ...
  React.useEffect(() => {
    ...
    if (promoResult) {
      ...
      setPromoDiscountType(
        (promoResult.discountType as "percentage" | "fixed") ?? "percentage"
      );
  ...
  const getDiscountedPrice = (amountCents: number) => {
    ...
    if (promoDiscountType === "percentage") {
      return Math.max(
        0,
        amountCents - Math.round((amountCents * promoDiscount) / 100)
      );
    }
    return Math.max(0, amountCents - Math.round(promoDiscount * 100));
  };

  const planOrder: Array<"daily" | "monthly" | "yearly"> = [
    "daily",
    "monthly",
    "yearly",
  ];
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="relative z-10 container pt-28 pb-20">
        ...
        <div className="text-center mb-10">
          ...
          >
            Pick Your <span className="text-emerald-gradient">Edge</span>
          </h1>
          <p className="mt-4 text-lg max-w-xl mx-auto text-white/45">
            Join{" "}
            {siteStats
              ? `${Math.round(siteStats.totalMembers / 1000)}K+`
              : "thousands of"}{" "}
            sharp bettors using AI-powered analytics, real-time odds, and
            professional tools to beat the books.
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 mt-5">
            <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full glass-card-static text-xs font-semibold">
              ...
              <span className="text-white/60">
                {siteStats?.paidSubscribers ?? "3,241"} active subscribers
              </span>
            </div>
            <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full glass-card-static text-xs font-semibold">
              <span className="text-[#39ff14]">✓</span>
              <span className="text-white/60">
                {siteStats ? `${siteStats.winRate.toFixed(1)}%` : "71.4%"} AI
                win rate
              </span>
            </div>
            <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full glass-card-static text-xs font-semibold">
              ...
              <span className="text-white/60">
                {siteStats?.picksToday ?? 8} picks live today
              </span>
            </div>
          </div>
        ...
        <div className="max-w-2xl mx-auto mb-14">
          ...
          {!promoApplied && (
            <PromoBanner onApply={() => setPromoCode("CHALK15")} />
          )}

          {/* Promo code input card */}
          <NeonCard
            className="p-6"
            variant={promoApplied ? "premium" : "default"}
          >
              ...
              >
                ...
                <p className="text-xs font-semibold text-brand-green">
                  {promoDiscountType === "percentage"
                    ? `${promoDiscount}% off`
                    : `$${promoDiscount} off`}{" "}
                  all plans! Discount reflected in prices below.
                </p>
              </div>
            )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 max-w-5xl mx-auto mb-14">
          {plans.map(plan => {
            ...
            const hasDiscount =
              promoApplied && discountedCents < plan.amountCents;
            ...
            return (
              ...
              >
                ...
                <NeonCard
                  ...
                  variant={
                    isPopular ? "premium" : isCurrent ? "accent" : "default"
                  }
                  interactive={false}
                  style={{
                    boxShadow: isPopular
                  ...
                  <div className="mb-7">
                    ...
                    {plan.key === "yearly" && !hasDiscount && (
                      <div className="text-xs mt-1.5 text-brand-gold">
                        = ${(originalPrice / 12).toFixed(2)}/mo · Save $14/mo vs
                        Pro
                      </div>
                    )}
                  ...
                  {isCurrent ? (
                    ...
                    >
                      <NativePurchaseButton
                        tier={plan.key as "daily" | "monthly" | "yearly"}
                        label={
                          hasDiscount
                    ...
                    <button
                      onClick={() =>
                        handleSubscribe(
                          plan.key as "daily" | "monthly" | "yearly"
                        )
                      }
                      disabled={isLoading}
        ...
        {showComparison && (
          <NeonCard
            className="max-w-5xl mx-auto overflow-hidden mb-14 p-8"
            interactive={false}
          >
                    ...
                    {category.features.map((feature, fIdx) => (
                      <div
                        ...
                        style={{
                          ...
                          borderLeft: "2px solid rgba(57,255,20,0.1)",
                        }}
                      >
        ...
        <div className="max-w-2xl mx-auto text-center">
          <NeonCard className="p-8" variant="accent" interactive={false}>
            <div
              className="w-14 h-14 flex items-center justify-center mx-auto mb-5 rounded-2xl"
              style={{
                background: "rgba(212,160,23,0.08)",
                border: "1px solid rgba(212,160,23,0.2)",
              }}
            ...
            <p className="text-sm text-white/45 leading-relaxed">
              Not satisfied? Contact us within 48 hours of your first purchase
