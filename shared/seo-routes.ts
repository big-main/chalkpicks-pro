...
export const routeSEO: RouteSEOEntry[] = [
  ...
  },
  {
    path: "/picks",
    title:
      "Today's AI Sports Betting Picks with Confidence Scores | ChalkPicks",
    description:
  ...
  },
  {
    path: "/ev-finder",
    title:
      "+EV Bet Finder — Real-Time Positive Expected Value Bets | ChalkPicks",
    description:
  ...
  },
  {
    path: "/arbitrage",
    title:
      "Sports Betting Arbitrage Finder — Risk-Free Profit Scanner | ChalkPicks",
    description:
  ...
  },
  {
    path: "/tools",
    title:
      "Sports Betting Power Tools — EV, Arbitrage, Props & More | ChalkPicks",
    description:
  ...
  },
  {
    path: "/blog",
    title:
      "Sports Betting Analytics Blog — Strategy & AI Insights | ChalkPicks",
    description:
  ...
  },
  {
    ...
    description:
      "Log in to your ChalkPicks account to access AI picks and betting tools.",
    sitemap: true,
    changefreq: "monthly",
    priority: 0.5,
  },
  ...
  },
  {
    ...
    title:
      "Odds Calculator — Convert American, Decimal & Fractional Odds | ChalkPicks",
    description:
      "Free sports betting odds calculator. Convert American, decimal, and fractional odds instantly. Calculate implied probability and payout.",
    sitemap: true,
    changefreq: "monthly",
    priority: 0.8,
  },
  {
    ...
    description:
      "Free ROI calculator for sports bettors. Calculate return on investment, profit/loss, and long-term performance across your betting history.",
    sitemap: true,
    changefreq: "monthly",
    priority: 0.8,
  },
  {
    ...
    title:
      "Sports Betting Bankroll Manager — Track & Protect Your Bankroll | ChalkPicks",
    description:
  ...
  },
  {
    ...
    description:
      "Free parlay calculator. Add multiple legs and instantly calculate combined odds, true probability, and potential payout for any parlay.",
    sitemap: true,
    changefreq: "monthly",
    priority: 0.8,
  },
  {
    ...
    description:
      "Free devig calculator. Remove the sportsbook's vig from any line to find the true no-vig probability and fair odds.",
    sitemap: true,
    changefreq: "monthly",
    priority: 0.7,
  },
  {
    ...
    description:
      "Full transparency on ChalkPicks AI pick performance. View verified win rate, ROI, units won, and graded results.",
    sitemap: true,
    changefreq: "daily",
    priority: 0.9,
  },
  {
    ...
    description:
      "See ChalkPicks AI performance leaderboard — win rates, streaks, and ROI by sport. Track which sports our AI model performs best on in real-time.",
    sitemap: true,
    changefreq: "daily",
    priority: 0.85,
  },
  {
    ...
    description:
      "Get free AI-generated sports betting picks every day. NFL, NBA, MLB, NHL picks with confidence scores. No credit card required.",
    sitemap: true,
    changefreq: "daily",
    priority: 0.95,
  },
  {
    ...
    title:
      "AI Betting Strategy Builder — Build & Backtest Custom Strategies | ChalkPicks",
    description:
      "Build, configure, and backtest custom sports betting strategies with AI. Define your edge, set filters, and simulate performance before risking real money.",
    sitemap: true,
    changefreq: "weekly",
    priority: 0.85,
  },
  {
    ...
    title:
      "Free Bet Converter — Convert Sportsbook Promos to Cash | ChalkPicks",
    description:
      "Convert sportsbook free bet bonuses into guaranteed cash profit using hedging. Calculate the exact hedge bet needed to lock in real money from any free bet.",
    sitemap: true,
    changefreq: "monthly",
    priority: 0.8,
  },
  {
    ...
    title:
      "Middles Finder — Find Middle Opportunities in Sports Betting | ChalkPicks",
    description:
      "Find middle opportunities where you can win both sides of a bet. Calculate the middle window, probability, and expected value for any game.",
    sitemap: true,
    changefreq: "monthly",
    priority: 0.8,
  },
  {
    path: "/guides",
    title:
      "Sports Betting Guides — Free Strategy Guides for Bettors | ChalkPicks",
    description:
      "Free sports betting strategy guides covering +EV betting, bankroll management, arbitrage, Kelly Criterion, line shopping, and more.",
    sitemap: true,
    changefreq: "weekly",
    priority: 0.85,
  },
  {
    ...
    description:
      "Track public betting percentages across all sports. See bet % vs money %, identify sharp vs public splits, and find reverse line movement signals.",
    sitemap: true,
    changefreq: "daily",
    priority: 0.9,
  },
  ...
  },
  {
    path: "/verify",
    title:
      "Pick Verification Ledger — Cryptographic Proof of Pre-Game Locks | ChalkPicks",
    description:
  ...
  },
  {
    path: "/methodology",
    title:
      "Our AI Methodology — How ChalkPicks Models Generate Picks | ChalkPicks",
    description:
      "Deep dive into ChalkPicks AI methodology: ensemble models, CLV tracking, Elo ratings, Monte Carlo simulations, and edge detection algorithms.",
    sitemap: true,
    changefreq: "monthly",
    priority: 0.85,
  },
  {
    path: "/how-it-works",
    title: "How ChalkPicks Works — From Data to Profitable Picks | ChalkPicks",
    description:
      "Learn how ChalkPicks transforms real-time odds data into AI-powered betting picks. Odds ingestion, model scoring, CLV verification, and delivery.",
    sitemap: true,
    changefreq: "monthly",
    priority: 0.85,
  },
  ...
  [
    {
      ...
      title:
        "Best AI Sports Betting Tools 2026: Revolutionizing How We Bet | ChalkPicks Blog",
      description:
    ...
    },
    {
      ...
      title:
        "AI Sports Picks vs Human Handicappers: Which is Better? | ChalkPicks Blog",
      description:
    ...
    },
    {
      ...
      title:
        "Edge Score Explained: A Bettor's Complete Guide | ChalkPicks Blog",
      description:
